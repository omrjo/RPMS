...
<body>
	...
	session_start();
	$id = $_SESSION["id"];
	$query = "SELECT projects.id,projects.title FROM Projects JOIN validate ON validate.Proid = Projects.id where validate.Resid = '$id' ";
...
<div class="box">
	<div class="head"><h3>Projects needs your review:</h3></div>
		...
		while ($row = mysqli_fetch_row($result))
		 {
			...
			print("<td><a href = 'RevProject.php?id=$row[0]'>$row[1]</td></tr>");
		}
	}
